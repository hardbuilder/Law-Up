        ...
        <div className="relative w-full pt-40 pb-20 px-4">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="bg-transparent rounded-2xl p-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-10 justify-items-center max-w-2xl mx-auto">
                <TeamMemberCard name="Om Takale" imageUrl="..." />
                <TeamMemberCard name="Muskan Kumari" imageUrl="..." />
              </div>
            </div>
